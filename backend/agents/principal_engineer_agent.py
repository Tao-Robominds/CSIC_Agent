...
Participate in the panel discussion, staying in character as the Principal Engineer throughout your responses."""
    ...
    def perceiver(self) -> Dict[str, str]:
        ...
        # Retrieve information from vector database from principal engineer perspective
    ...
    def _retrieve_from_vector_db(self, query: str) -> Dict:
        """Retrieve information from LlamaIndex vector database from principal engineer perspective"""
        try:
            # Create LlamaIndex request
            request = LlamaIndexRequest(
                query=query,
                perspective="principal_engineer",
                top_k=3
            )
